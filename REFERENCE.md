...
**Baseline recorded 2026-08-15, 10:43 EST:** Dahlia is rated **1977 blitz** over 87 games — 47 wins, 7 draws, 33 losses. This is the figure Milestone 6's gain is measured against, and it is the first Elo number the project has ever had. Note what it is not: it is a rating in motion over a small sample, not a converged one, and the milestone's own changes are part of what moves it.
